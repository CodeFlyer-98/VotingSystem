<footer class="main-footer" style="background-color: #20525C; color: white; font-size: 13px; font-weight:bold">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <div style="margin-top: 10px;">
          <h4 style="color: white; font-size: 16px;">Help & Contact Us</h4>
          <p style="color: white; font-size: 14px;">Connect with us on social media:</p>
