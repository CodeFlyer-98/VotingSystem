<aside class="main-sidebar" style="background-color: #44426f;">
  <!-- sidebar: style can be found in sidebar.less -->
  <section class="sidebar" style="background-color: #44426f;">
    <!-- Sidebar user panel -->
    ...
    <ul class="sidebar-menu" data-widget="tree" style="background-color: #44426f; color: white; font-size: 15px; font-family: Times;">
      <li class="header" style="background-color: #afa25e; color: white; font-size: 12px; font-family: Times;">REPORTS</li>
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
      <li class=""><a href="votes.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes</span></a></li>
      <li class="header" style="background-color: #afa25e; color: white; font-size: 12px; font-family: Times;">MANAGE</li>
      ...
      <li class="header" style="background-color: #afa25e; color: white; font-size: 12px; font-family: Times;">SETTINGS</li>
