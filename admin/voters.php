                ...
                <div class="col-xs-12">
                    <div class="box" style="background-color: #d8d1bd">
                        <div class="box-header with-border" style="background-color: #d8d1bd">
                            <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-curve " style="background-color: #4682B4; color:black; font-size: 12px; font-family: Times">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table">
                                <thead>
                                    ...
                                    <th>Photo</th>
                                    <th>Voters ID</th>
                                    <th style="font-weight: bold; font-size: 18px;">Verification Code (OTP)</th> <!-- Bigger size and more visible color -->
                                    <th>Tools</th>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    while($row = $query->fetch_assoc()){
                                        ...
                                        echo "
                                          <tr style='color:black; font-size: 15px; font-family: Times'>
                                            ...
                                            <td>".$row['voters_id']."</td>
                                            <td style='font-weight: bold; font-size: 20px; color: #4caf50;'>
                                                ".$row['otp']."
                                                <br>
                                                <small style='font-size: 80%; color: #888;'>This is your one-time Verification Code</small>
                                            </td> <!-- Bigger size and more visible color -->
                                            <td>
