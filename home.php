	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
							...
							$selectStatus = "SELECT * FROM admin WHERE id=1";
							$status = mysqli_query($conn,$selectStatus);
							$res = mysqli_fetch_assoc($status);
							if($res['vote_status'] == "off"){
    							 echo nl2br("<span style='font-size: 30px;color: #006400;font-weight:bold;'>\nVoting is not started yet</span> \n\n 
								 <span style='font-size: 20px;color: #006400;'>please wait some time </span> ");
							}else{
				    		?>
			    			<!-- Voting Ballot -->
